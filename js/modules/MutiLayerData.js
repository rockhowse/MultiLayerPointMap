...
// initializes the key press listeners for the margin data
initializeMultiLayerData  = function(scene, auto_start, start_map) {
    ...
    // renders PointMap data based on type selectedSS
    $(".type-button").click(function() {
        this.buildMapFromMultiLayerData(scene, $(this).attr("id"));
    });
    ...
    $("#MultiLayerPointMap").click(function(){
        $("#menu").hide()
        loadStarmap(4);
    });
...
PointMapInfo = function(title, date, time, description) {
    this.title          = title;
    this.date           = date;
    this.time           = time;
...
function loadFlashCrashStarMapGrid() {
    ...
    var flash_crash_array = [
        ["20100506",
            new PointMapInfo("Flash Crash", "May 06 2010", "14:42:44 ET", "System Failure"),
            [
        ...
        ["20100505",
            new PointMapInfo("Day Before Flash Crash", "May 05 2010", "Close", "Servers were upgraded."),
            [
        ...
        ["20100504",
            new PointMapInfo("Normal Day", "May 04 2010", "14:42:44 ET", "No Market Anomalies"),
            [
        ...
        ["20100428",
            new PointMapInfo("Flash Crash", "Apr 28 2010", "??:??:?? ET", "Previous week showed systems under stress."),
            [
        ...
        ["20080929",
            new PointMapInfo("Flash Crash", "Sep 29 2008", "??:??:?? ET", "Previous week showed systems under stress."),
            [
